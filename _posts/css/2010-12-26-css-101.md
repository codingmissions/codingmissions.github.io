...
categories:
  - css
description: CSS 101 - Introduction of CSS
type: Document
---

Have you ever wondered who makes our web pages beautiful? How the page elements are beautifully laid on proper positions?
How different web page has different format of text?

The answer is `Cascading Style Sheets`, whose nick name is `CSS`.
